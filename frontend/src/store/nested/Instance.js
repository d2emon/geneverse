  ...
  generateName (name) {
    ...
    function happyThoughtText () {
      return weightedChoose([
          ...
          choose([
            'Hmm! I should get', 'I know what would be awesome...', 'Time for', 'I need', 'You know what? I need', "Know what I need? I'll tell you - "]) + ' ' + Choose(['some new shoes', 'a new TV', 'a new computer', 'a new car', 'a bigger house', 'a cooler job', 'a lover', 'more pets', 'a makeover', 'a good movie', 'a nice dinner in town'
          ]) +
            '!',
          choose([
            'This is the best relationship ever.', 'I love being married!', "Marriage isn't as bad as they make it out to be!", 'This relationship is awesome!', 'I love my family.', 'I love doing stuff with my family.'
          ]),
          choose([
            choose([
